...
echo "<br>This machine is controlled by AutoScaling Group has Firewall access managed using AWS Security Group with ID by ${security_group_id}.</br>" >> /var/www/html/index.htm